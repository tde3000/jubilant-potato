...
class TestTalk(CommandTest):
    ...
    def test_talk(self):
        ...
        returned_dialog = self.call(CmdTalk(), npc.key, caller=self.char1)
        self.assertTrue(expected_npc in returned_dialog, "Dialog does not contain '{}'".format(expected_npc))
